...
//Conceptos básicos de indexedDB https://developer.mozilla.org/es/docs/Web/API/IndexedDB_API/Conceptos_Basicos_Detras_De_IndexedDB 
    ...
    const readData = () => {
        ...
        request.onsuccess = (e) => {
            ...
            if (cursor) {
                ...
                taskDelete.dataset.type = 'delete' //Le decimos que el boton delete borra los datos.
                taskDelete.dataset.key = cursor.key // Acá le decimos que dato debe borrar
