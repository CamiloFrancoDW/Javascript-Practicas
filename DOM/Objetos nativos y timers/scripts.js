...
/*
Objeto window - Es el objeto global, de él descienden todos los objetos. Windows es el objeto global. 
    alert()
    prompt()
    confirm()
*/
...
//location.href = 'https://google.com' // Esto es una forma de redirigir.
